        ...
        {open && (
          ...
          >
            <motion.div
              ...
              className={cn(
                "z-[80] flex flex-col rounded-[var(--radius-6)] bg-background-100 border border-[var(--gray-alpha-400)] shadow-menu outline-none overflow-hidden",
                className,
              )}
            >
...
export function ComboboxItem({
  ...
  return (
    <div
      ...
      className={cn(
        "flex cursor-default items-center gap-2 rounded-[var(--radius-6)] px-2 py-1.5 text-label-13 text-gray-1000 outline-none transition-colors duration-[var(--duration-state)] ease-[var(--ease-standard)] data-[active]:bg-[var(--menu-item-hover)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
      {...getItemProps({

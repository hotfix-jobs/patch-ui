  ...
  return (
    <div className="w-full max-w-md">
      <Accordion defaultValue={["item-0"]}>
        <AccordionItem value="item-0" className="border-t border-patch-border last:border-b">
        ...
        <AccordionItem value="item-1" className="border-t border-patch-border last:border-b">
        ...
        <AccordionItem value="item-2" className="border-t border-patch-border last:border-b">

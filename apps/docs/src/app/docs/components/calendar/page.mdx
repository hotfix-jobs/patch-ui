...
import { CalendarModesDemo } from "./calendar-modes-demo";
import { CalendarConstraintsDemo } from "./calendar-constraints-demo";

export const metadata = {
  title: "Calendar",
  alternates: { canonical: "/docs/components/calendar" },
};

export const usageCode = `const [date, setDate] = useState<Date | null>(null);

<Calendar mode="single" value={date} onValueChange={setDate} />`;

<PageHeader
  title="Calendar"
  description="A month grid for selecting one date, a date range, or multiple dates."
/>
...
<ComponentPreview label="Single date" sourcePath="src/app/docs/components/calendar/calendar-demo.tsx" resettable>
  <CalendarDemo />
</ComponentPreview>
...
<ComponentPreview label="Range and multiple selection" sourcePath="src/app/docs/components/calendar/calendar-modes-demo.tsx" resettable>
  <CalendarModesDemo />
</ComponentPreview>
...
<ComponentPreview label="Date constraints" sourcePath="src/app/docs/components/calendar/calendar-constraints-demo.tsx" resettable>
...
<PropsTable props={[
  { name: "mode", type: '"single" | "range" | "multiple"', default: '"single"', description: "Selects the value contract and selection behavior." },
  { name: "value / onValueChange", type: "Date | null | DateRange | Date[] / (value) => void", description: "Controls selection using the value shape associated with mode." },
  { name: "defaultValue", type: "Date | null | DateRange | Date[]", description: "Sets initial selection when state is uncontrolled." },
  { name: "weekStartsOn", type: "0 | 1 | 2 | 3 | 4 | 5 | 6", default: "0", description: "Sets the first weekday, where 0 is Sunday and 1 is Monday." },
  { name: "fromDate / toDate", type: "Date / Date", description: "Sets inclusive minimum and maximum selectable dates." },
  { name: "disabledDates", type: "(date: Date) => boolean", description: "Disables dates for which the predicate returns true." },
]} />

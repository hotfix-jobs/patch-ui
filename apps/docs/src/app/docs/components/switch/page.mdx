...
<Callout title="Notes">
- **Switch vs Checkbox:** Use a switch for settings that take effect immediately (e.g. "Enable notifications"). Use a [Checkbox](/docs/components/checkbox) for options that require a form submission.

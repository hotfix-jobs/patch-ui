...
```css
@theme inline {
  --color-patch-bg: var(--background-100);
  --color-patch-surface: var(--background-100);
  --color-patch-text: var(--gray-1000);
  /* ... all 14 colors */
}
```
...
```html
<div class="bg-background-100 text-gray-1000 border-gray-alpha-400">
...
| `--shadow-menu` | `0 4px 12px -2px rgba(0,0,0,0.4)` |
| `--shadow-menu` | `0 8px 24px -4px rgba(0,0,0,0.5)` |
| `--shadow-modal` | `0 16px 48px -12px rgba(0,0,0,0.6)` |

Used via Tailwind utilities: `shadow-card`, `shadow-menu`, `shadow-menu`, `shadow-modal`.
